...
class izle720Provider : MainAPI() {
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        val items = document.select("div.film-box, article.film, .movie-box").mapNotNull { it.toSearchResult() }
    ...
    override suspend fun search(query: String): List<SearchResponse> {
        ...
        return document.select("div.film-box, article.film, .movie-box").mapNotNull { it.toSearchResult() }
    }
