package com.xcloudstream.FilmKutusu
...
class FilmKutusuProvider : MainAPI() {
    override var mainUrl = "https://filmkutusu.com"
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        val items = document.select("div.film-box, article.film, .movie-card").mapNotNull { it.toSearchResult() }
    ...
    override suspend fun search(query: String): List<SearchResponse> {
        ...
        return document.select("div.film-box, article.film, .movie-card").mapNotNull { it.toSearchResult() }
    }
